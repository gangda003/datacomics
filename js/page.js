  ...
  addMessageListener: function() {
    chrome.extension.onMessage.addListener(function(request, sender, response) {
      ...
      switch (request.msg) {
        ...
        case 'show_SVG_area': //alert("svg area"); 
        svg_crow.init(); break;
        case 'show_HTMLTable_area': //alert("svg area"); 
        HTMLTable_crow.init(); break;
        ...
        case 'capture_selected':
          ...
          //********** Capture SVG and return in the resopnse object
        case 'capture_SVG':
          response(page.scrollInit(
              page.startX, page.startY,
              page.calculateSizeAfterZooming(page.endX - page.startX),
